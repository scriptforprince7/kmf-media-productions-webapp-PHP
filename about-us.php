      ...
      <div class="icon-features">
        <div class="container">
          <div class="row justify-content-md-center">
            <div class="col-md-4 col-sm-4 col-12 wow fadeIn"> <img src="images/icon01.png" alt="Image"> <small>Customized Campaigns</small>
              <p>Tailored marketing campaigns designed to meet your specific requirements and target audience..</p>
              <!--<a href="#">DISCOVER MORE</a>-->
            </div>
            <!-- end col-4 -->
            <div class="col-md-4 col-sm-4 col-12 wow fadeIn"> <img src="images/icon02.png" alt="Image">
              <small>Extensive Experience</small>
              <p>Having collaborated with over 3000 artists and more than 30 labels, including industry giants like Zee Music.</p>
              <!--<a href="#">DISCOVER MORE</a>-->
            </div>
            <!-- end col-4 -->
            <div class="col-md-4 col-sm-4 col-12 wow fadeIn"> <img src="images/icon03.png" alt="Image">
              <small>Result-Oriented Approach</small>
              <p>Our team of marketing experts specializes in strategizing and executing campaigns that deliver tangible results.</p>
              <!--<a href="#">DISCOVER MORE</a>-->
            </div>
            <!-- end col-4 -->
            <div class="col-md-4 col-sm-4 col-12 wow fadeIn"> <img src="images/icon04.png" alt="Image">
              <small>Artist Growth</small>
              <p>We don't just promote songs; we focus on the holistic growth of both the artist and the music.</p>
              <!--<a href="#">DISCOVER MORE</a>-->
            </div>
            <!-- end col-4 -->
            <div class="col-md-4 col-sm-4 col-12 wow fadeIn"> <img src="images/icon05.png" alt="Image">
              <small>Reels Promotions</small>
              <p>Solutions in seconds! ⏱️ Dive into our Reels to discover how our services can transform your world.</p>
              <!--<a href="#">DISCOVER MORE</a>-->
            </div>
            <!-- end col-4 -->
          </div>
