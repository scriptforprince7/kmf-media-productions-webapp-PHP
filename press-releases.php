        ...
        <section class="slider">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <!--</div>-->
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/press-release1.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
                    ...
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/press-release2.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
            ...
            <div class="project-detail">
                <div class="container">
                    ...
                    <div class="project" id="client">
                       <span class="whats-app" id="whatsapp-message"><h2>Press Releases</h2></span> 
                        <p class="lead">
                           <h3 style="font-size:40px;">Traditional yet effective print press releases for a wider reach.</h3> 
                        </p><br>
                        <p>
                            Announce your success with impact! Our Press Release Service ensures your news reaches the right audience, creating a buzz that resonates across media channels.

                            Make headlines that matter. Our Press Release Service is designed to elevate your news, ensuring it grabs attention and leaves a lasting impression in the media landscape. Your news, our expertise. Elevate your brand with our impactful Press Release Service.
                        </p>

                        <section class="content">
                            <div class="about-studio">
                                <figure class="hero-image wow fadeInUp"> <img src="inner-images/press-release.jpg" alt="Image"></figure>
                                <!--<div class="container">-->
                                <!--    <div class="row">-->
