            ...
            <div class="project-detail">
                <div class="container">
                    ...
                    <div class="project" id="client">
                      <span class="whats-app" id="whatsapp-message"> <h2>Marketing Consultation</h2></span> 
                        <p class="lead">
                        <h3 style="font-size:40px;"><b>Transform your marketing game with our expert consultation. Elevate your brand and maximize ROI.</b></h3>    
                        </p><br>
                        <p>
                            Revolutionize your marketing approach with our Consultation Service. From market analysis to campaign optimization, we're here to ensure your brand stands out in today's competitive landscape.

                            Experience a paradigm shift in your marketing efforts. Our Consultation Service is designed to analyze, optimize, and strategize, ensuring your business connects with the right audience at the right time.
                        </p>

                        <section class="content">
                            <div class="about-studio">
                                <figure class="hero-image wow fadeInUp"> <img src="inner-images/marketing-consultation.jpg" alt="Image"></figure>
                                <!--<div class="container">-->
                                <!--    <div class="row">-->
