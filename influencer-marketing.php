        ...
        <section class="slider">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <!--</div>-->
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/influencer-marketing1.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
                    ...
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/influencer-marketing2.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
            ...
            <div class="project-detail">
                <div class="container">
                    ...
                    <div class="project" id="client">
                     <span class="whats-app" id="whatsapp-message"> <h2>Influencer Marketing</h2></span>  
                        <p class="lead">
                           <h3 style="font-size:40px;">Strategic collaborations with influencers to amplify your music to diverse audiences.</h3> 
                        </p><br>
                        <p>
                            Turn heads and hearts with our Influencer Marketing prowess. We curate partnerships that go beyond endorsements, creating authentic connections between your brand and influencers who genuinely align with your values.

                            Elevate your brand with influential partnerships. Our Influencer Marketing service goes beyond metrics, focusing on meaningful collaborations that create a genuine impact on your audience, driving brand loyalty and advocacy.
                        </p>

                        <section class="content">
                            <div class="about-studio">
                                <figure class="hero-image wow fadeInUp"> <img src="inner-images/influencer-marketing.jpg" alt="Image"></figure>
                                <!--<div class="container">-->
                                <!--    <div class="row">-->
		...
		<ul class="pricing-list bounce-invert">
			...
			<li class="exclusive">
				<ul class="pricing-wrapper">
					<li data-type="monthly" class="is-visible">
						<header class="pricing-header">
							<h2 style="font-size:42px; color:#BC3C93;">Fan Finder <br>(<span style="color:	#DAA520;">Gold</span>)</h2>
							<div class="price">
								<span class="currency">₹</span>
