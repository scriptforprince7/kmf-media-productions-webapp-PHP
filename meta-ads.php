        ...
        <section class="slider">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <!--</div>-->
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/meta-ads1.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
                    ...
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/meta-ads2.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
            ...
            <div class="project-detail">
                <div class="container">
                    ...
                    <div class="project" id="client">
                      <span class="whats-app" id="whatsapp-message"><h2>Meta Ads</h2></span>  
                        <p class="lead">
                           <h3 style="font-size:40px;">Maximize Impact with Meta Ads - Click, Convert, Succeed.</h3> 
                        </p><br>
                        <p>
                            In the ever-evolving landscape of digital advertising, Meta Ads stand as your beacon of precision and impact. Seamlessly blending targeted reach with actionable results, our Meta Ads service catapults your brand into the spotlight, ensuring every click translates into meaningful conversions. Embrace the power of Meta Ads and witness your online presence transform into a dynamic force, resonating with your audience and propelling your business.
                        </p>

                        <section class="content">
                            <div class="about-studio">
                                <figure class="hero-image wow fadeInUp"> <img src="inner-images/meta-ads.jpg" alt="Image"></figure>
                                <!--<div class="container">-->
                                <!--    <div class="row">-->
		...
		<ul class="pricing-list bounce-invert">
			...
			<li class="exclusive">
				<ul class="pricing-wrapper">
					<li data-type="monthly" class="is-visible">
						<header class="pricing-header">
							<h2 style="font-size:42px; color:#1C428D;">Fan Finder <br>(<span style="color:	#DAA520;">Gold</span>)</h2>
							<div class="price">
								<span class="currency">₹</span>
