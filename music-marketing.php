        ...
        <section class="slider">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <!--</div>-->
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/music-marketing1.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
                    ...
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/music-marketing2.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
            ...
            <div class="project-detail">
                <div class="container">
                    ...
                    <div class="project" id="client">
                      <span class="whats-app" id="whatsapp-message"><h2>Music Marketing</h2></span>  
                        <p class="lead">
                        ...
                        <section class="content">
                            <div class="about-studio">
                                <figure class="hero-image wow fadeInUp"> <img src="inner-images/music-marketing.jpg" alt="Image"></figure>
...
@keyframes rotate-inverse-back {
  ...
  100% {
    ...
    border-radius: 30px; /* Increase the border-radius */
    box-shadow:
