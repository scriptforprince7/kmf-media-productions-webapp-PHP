        ...
        <section class="slider">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <!--</div>-->
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/reels-prmotions1.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
                    ...
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/reels-prmotions2.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
            ...
            <div class="project-detail">
                <div class="container">
                    ...
                    <div class="project" id="client">
                      <span class="whats-app" id="whatsapp-message"><h2>Reels Promotions</h2></span>  
                        <p class="lead">
                          <h3 style="font-size:40px;">Leveraging Instagram Reels for widespread promotion and engagement.</h3> 
                        </p><br>
                        <p>
                            Ignite your brand's presence on Instagram with dynamic Reels promotions. Our strategy turns short-form content into a powerful tool for engagement, expanding your reach and captivating audiences in a matter of seconds.

                            Dive into the world of rapid engagement with our Reels promotions. We'll transform your brand into a trending topic, leveraging short-form videos to create buzz, drive traffic, and boost your online visibility.
                        </p>

                        <section class="content">
                            <div class="about-studio">
                                <figure class="hero-image wow fadeInUp"> <img src="inner-images/reels-promotions.jpg" alt="Image"></figure>
                                <!--<div class="container">-->
                                <!--    <div class="row">-->
		...
		<ul class="pricing-list bounce-invert">
			...
			<li class="exclusive">
				<ul class="pricing-wrapper">
					<li data-type="monthly" class="is-visible">
						<header class="pricing-header">
							<h2 style="font-size:42px; color:#F55020;">Fan Finder <br>(<span style="color:	#DAA520;">Gold</span>)</h2>
							<div class="price">
								<span class="currency">₹</span>
