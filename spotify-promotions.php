        ...
        <section class="slider">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <!--</div>-->
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/spotify-promotion1.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
                    ...
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/spotify-promotion2.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
            ...
            <div class="project-detail">
                <div class="container">
                    ...
                    <div class="project" id="client">
                     <span class="whats-app" id="whatsapp-message"> <h2>Spotify Promotions</h2></span>  
                        <p class="lead">
                          <h3 style="font-size:40px;">Tailored campaigns to boost your presence on one of the leading music streaming platforms.</h3> 
                        </p> <br>
                        <p>
                            Elevate your music to new heights with our Spotify Promotions Service! Reach a wider audience and boost your streams organically.

                           Don't let your music go unnoticed. Supercharge your Spotify presence with our tailored promotion service. More streams, more fans, more success!
                        </p>

                        <section class="content">
                            <div class="about-studio">
                                <figure class="hero-image wow fadeInUp"> <img src="inner-images/spotify-promotion.jpg" alt="Image"></figure>
                                <!--<div class="container">-->
                                <!--    <div class="row">-->
		...
		<ul class="pricing-list bounce-invert">
			...
			<li class="exclusive">
				<ul class="pricing-wrapper">
					<li data-type="monthly" class="is-visible">
						<header class="pricing-header">
							<h2 style="font-size:42px;">Fan Finder <br>(<span style="color:	#DAA520;">Gold</span>)</h2>
							<div class="price">
								<span class="currency">₹</span>
...
@keyframes rotate-inverse-back {
  ...
  100% {
    ...
    .project-detail .project h2 {
        font-size: 61px; /* Adjust this size according to your preference for smaller screens */
    }
