        ...
        <section class="slider">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <!--</div>-->
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/music-distribution1.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
                    ...
                    <!-- end swiper-slide -->
                    <div class="swiper-slide bg-image" data-background="banner-images/d/music-distribution2.jpg" data-stellar-background-ratio="0.5">
                        <!--<div class="inner">-->
        ...
        <section class="content">
            <div class="project-detail">
                <div class="container">
                    ...
                    <span class="whats-app" id="whatsapp-message"> <h2>Music Distribution</h2></span>   
                        <p class="lead">
                           <h3 style="font-size:40px;">Distribute your music effortlessly with our service. </h3> 
                        </p><br>
                        <p>
                            From studio to global stage, our music distribution service is your bridge to a wider audience. We strategically place your tracks on diverse platforms, maximizing visibility and helping you build a dedicated fanbase.

                            Globalize your sound with our music distribution service. We pave the way for your music to be heard on a variety of platforms, ensuring it doesn't just get played but becomes an integral part of listeners' playlists.
                        </p>

                        <section class="content">
                            <div class="about-studio">
                                <figure class="hero-image wow fadeInUp"> <img src="inner-images/music-distribution.jpg" alt="Image"></figure>
                                <!--<div class="container">-->
                                <!--    <div class="row">-->
		...
		<ul class="pricing-list bounce-invert">
			...
			<li class="exclusive">
				<ul class="pricing-wrapper">
					<li data-type="monthly" class="is-visible">
						<header class="pricing-header">
							<h2 style="font-size:42px; color:#1ECBAF;">Fan Finder <br>(<span style="color:	#DAA520;">Gold</span>)</h2>
							<div class="price">
								<span class="currency">₹</span>
